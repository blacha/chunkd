...
// export function validateConfig(cfg: AwsCredentialProvider, path: URL): AwsCredentialProvider {
...
//   constructor(path: URL, fs: FileSystem) {
//     this.path = path;
//     this.fs = fs;
//   }
...
//   async findCredentials(path: URL): Promise<AwsCredentialConfig | null> {
//     const cfg = await this.config;
//     for (const credentials of cfg.prefixes) {
//       if (path.href.startsWith(credentials.prefix)) return credentials;
//     }
//     return null;
//   }
// }
...
// export class FsAwsS3Provider implements FileSystemProvider<FsAwsS3> {
...
//   createFileSystem(acc: AwsCredentialConfig): FsAwsS3;
